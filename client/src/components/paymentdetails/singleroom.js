...
const SingleRoom = () => {
  ...
  const id2 = idd.replace("/singleroom", "");
  ...
  useEffect(() => {
    {
      data
        ...
        .map((val) => {
          setTotalAmount(`Rs. ${val.singleroomfee}`);
          setPaymentTotalAmount(`${val.singleroomfee}`);
        });
    }
    console.log(id);
    fetch("/api/pg")
          ...
          return (
            <div className="main-box1">
              <div className="main-box2">
                ...
                <input value="Single Room" id="roomtype" hidden />
                <input value={myCoupon} id="couponused" hidden />
                <input
                  value={`Rs. ${val.singleroomfee}`}
                  id="perpersonamount"
                  hidden
                />
                ...
                <h4 className="total-amount">Single Room</h4>
                <h4 className="title-pgname">Room Type: </h4>
                <h4 className="total-amount">Rs. {val.singleroomfee}/person</h4>
