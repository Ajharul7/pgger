...
const ThreePersonRoom = () => {
  ...
  const id2 = idd.replace("/threepersonroom", "");
  ...
  useEffect(() => {
    {
      data
        ...
        .map((val) => {
          setTotalAmount(`Rs. ${val.threepersonroomfee}`);
          setPaymentTotalAmount(`${val.threepersonroomfee}`);
        });
    }
    console.log(id);
    fetch("/api/pg")
          ...
          return (
            <div className="main-box1">
              <div className="main-box2">
                ...
                <input value="Three Person Room" id="roomtype" hidden />
                <input value={myCoupon} id="couponused" hidden />
                <input
                  value={`Rs. ${val.threepersonroomfee}`}
                  id="perpersonamount"
                  hidden
                />
                ...
                <h4 className="total-amount">Three Person Room</h4>
                <h4 className="title-pgname">Room Type: </h4>
                <h4 className="total-amount">
                  Rs. {val.threepersonroomfee}/person
                </h4>
...
export default ThreePersonRoom;
